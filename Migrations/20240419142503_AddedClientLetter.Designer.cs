...
namespace Encyclopedia_Of_Laws.Migrations
{
    ...
    [Migration("20240419142503_AddedClientLetter")]
    partial class AddedClientLetter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Book", b =>
                {
                    b.Property<int>("IdB")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.ClientLetter", b =>
                {
                    b.Property<int>("LettertId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Part", b =>
                {
                    b.Property<int>("IdS")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Section", b =>
                {
                    b.Property<int>("IdP")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Subjects", b =>
                {
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Book", b =>
                {
                    b.HasOne("Encyclopedia_Of_Laws.Models.Part", "IdSNavigation")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Chapter1", b =>
                {
                    b.HasOne("Encyclopedia_Of_Laws.Models.Section", "IdPNavigation")
                        .WithMany("Chapter1s")
                        .HasForeignKey("IdP")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Section", b =>
                {
                    b.HasOne("Encyclopedia_Of_Laws.Models.Book", "IdBNavigation")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.Subjects", b =>
                {
                    ...
                    b.HasOne("Encyclopedia_Of_Laws.Models.Part", "IdSقسمNavigation")
                        .WithMany("Subjectsموادs")
            ...
            modelBuilder.Entity("Encyclopedia_Of_Laws.Models.ApplicationUser", b =>
                {
                    b.Navigation("ClientLetterLawyers");

                    b.Navigation("ClientLetterUsers");
